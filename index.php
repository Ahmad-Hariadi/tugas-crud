...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.php">Poltek GT</a></h1>
      ...
      <div class="container">
        ...
        <table border="2" align="center" width="95%">
          ...
          while($mhs = mysqli_fetch_array($query)){
            ...
            echo "<td>";
              echo "<a href='form-edit.php?id=".$mhs['nim']."'>Edit</a> | ";
              echo "<a href='hapus.php?id=".$mhs['nim']."'>Hapus</a>";
            echo "</td>";
            echo "</tr>";
          }
          ?>
      ...
      <div class="container">
        ...
        <!-- <div class="row">
          ...
          <div class="col-lg-5 col-md-12" data-aos="fade-up" data-aos-delay="300">
            <form action="proses_pendaftaran.php" method="POST" role="form" >
              ...
              <div class="text-center"><button type="submit" name="submit" value="Simpan">Save Data</button></div>
            </form>
          </div>
